...
#ifndef Faust_Compiler_Test_PluginConfig_H
#define Faust_Compiler_Test_PluginConfig_H
...
namespace Faust_Compiler_Test_PluginConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 19313;
}

#endif // Faust_Compiler_Test_PluginConfig_H

...
#include "../SoundEnginePlugin/Faust_Compiler_Test_PluginSourceFactory.h"
...
AK_DEFINE_PLUGIN_CONTAINER(Faust_Compiler_Test_Plugin);											// Create a PluginContainer structure that contains the info for our plugin
AK_EXPORT_PLUGIN_CONTAINER(Faust_Compiler_Test_Plugin);											// This is a DLL, we want to have a standardized name

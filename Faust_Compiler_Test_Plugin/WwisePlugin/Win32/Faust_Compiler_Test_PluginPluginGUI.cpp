...
HINSTANCE Faust_Compiler_Test_PluginPluginGUI::GetResourceHandle() const
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return AfxGetStaticModuleState()->m_hCurrentResourceHandle;
}

bool Faust_Compiler_Test_PluginPluginGUI::GetDialog(
...
bool Faust_Compiler_Test_PluginPluginGUI::WindowProc(
	AK::Wwise::Plugin::eDialog in_eDialog,
	HWND in_hWnd,
	uint32_t in_message,
	WPARAM in_wParam,
...
void Faust_Compiler_Test_PluginPluginGUI::initializeEditor(HWND in_hWnd)
{
...
void Faust_Compiler_Test_PluginPluginGUI::AddTooltip(HWND hTarget, const wchar_t* text)
{
	TOOLINFO ti = { 0 };
	ti.cbSize = sizeof(ti);
...
ProjectFileSelection Faust_Compiler_Test_PluginPluginGUI::getCurrentProjectFileSelection()
{
...
bool Faust_Compiler_Test_PluginPluginGUI::SetCodeEditorText()
{
...
bool Faust_Compiler_Test_PluginPluginGUI::SaveCodeEditorText()
{
...
void Faust_Compiler_Test_PluginPluginGUI::ShowSimpleWindow(LPCWSTR text, LPCWSTR title)
{
...
void Faust_Compiler_Test_PluginPluginGUI::OnBuildCompleted(WPARAM in_wParam, LPARAM in_lParam)
{
...
void Faust_Compiler_Test_PluginPluginGUI::OnDeleteProjectFile()
{
	int filesCount = (int)SendMessage(projectFilesCombo, CB_GETCOUNT, 0, 0);
	if (!filesCount)
	{
...
bool Faust_Compiler_Test_PluginPluginGUI::OnRenameAccepted(wchar_t *newName)
{
	// get the oldName
...
LRESULT CALLBACK Faust_Compiler_Test_PluginPluginGUI::onRenameWinProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg)
	{
	case WM_COMMAND:
		...
		{
			auto* self = (Faust_Compiler_Test_PluginPluginGUI*)
...
void Faust_Compiler_Test_PluginPluginGUI::OnRenameButtonClicked()
{
	int filesCount = (int)SendMessage(projectFilesCombo, CB_GETCOUNT, 0, 0);
	if (!filesCount)
	{
...
void Faust_Compiler_Test_PluginPluginGUI::OnNewProjectFile()
{
	// save code
	SaveCodeEditorText();
...
void Faust_Compiler_Test_PluginPluginGUI::OnProjectFileSelectionChange()
{
...
void Faust_Compiler_Test_PluginPluginGUI::OnExportClicked()
{
	SaveCodeEditorText();
...
int Faust_Compiler_Test_PluginPluginGUI::AskUserForDirectory(std::wstring& directory)
{
...
void Faust_Compiler_Test_PluginPluginGUI::onDocsClicked()
{
	ShellExecuteW(
		faustWnd,
		L"open",
...
void Faust_Compiler_Test_PluginPluginGUI::OnPreviewButtonClicked()
{   
...
void Faust_Compiler_Test_PluginPluginGUI::OnBuildButtonClicked(){
...
AK_ADD_PLUGIN_CLASS_TO_CONTAINER(
    ...
    Faust_Compiler_Test_PluginSource       // Corresponding Sound Engine plug-in class
);

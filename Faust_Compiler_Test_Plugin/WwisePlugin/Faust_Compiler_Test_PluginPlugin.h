...
class Faust_Compiler_Test_PluginPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    Faust_Compiler_Test_PluginPlugin();
    ~Faust_Compiler_Test_PluginPlugin();
...
AK_DECLARE_PLUGIN_CONTAINER(Faust_Compiler_Test_Plugin);	// Exposes our PluginContainer structure that contains the info for our plugin

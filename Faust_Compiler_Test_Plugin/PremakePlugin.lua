...
local Plugin = {}
Plugin.name = "Faust_Compiler_Test_Plugin"
Plugin.factoryheader = "../SoundEnginePlugin/Faust_Compiler_Test_PluginSourceFactory.h"
Plugin.appleteamid = ""
Plugin.signtoolargs = {}
Plugin.sdk = {}
Plugin.sdk.static = {}
...
{
    "Faust_Compiler_Test_PluginSourceShared.cpp"
}
...
{
    "Faust_Compiler_Test_PluginSourceShared.cpp",
    "Faust_Compiler_Test_PluginSourceFactory.h",
    "../FaustRuntime/**.cpp",
    "../FaustRuntime/**.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "Faust_Compiler_Test_Plugin.def",
    "Faust_Compiler_Test_Plugin.xml",
    "**.rc",
}

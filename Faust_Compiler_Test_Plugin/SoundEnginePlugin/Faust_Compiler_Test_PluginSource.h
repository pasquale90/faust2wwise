...
#ifndef Faust_Compiler_Test_PluginSource_H
#define Faust_Compiler_Test_PluginSource_H
...
class Faust_Compiler_Test_PluginSource
    : public AK::IAkSourcePlugin
{
public:
    Faust_Compiler_Test_PluginSource();
    ~Faust_Compiler_Test_PluginSource();
...
private:
    Faust_Compiler_Test_PluginSourceParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkSourcePluginContext* m_pContext;
    AkFXDurationHandler m_durationHandler;

    PluginLoader& pluginLoader = PluginLoader::getInstance();
    AkUInt32 GetSpeakerConfigChannelMask(int predefinedOutputs);
    int speakersAvail;
...
#endif // Faust_Compiler_Test_PluginSource_H

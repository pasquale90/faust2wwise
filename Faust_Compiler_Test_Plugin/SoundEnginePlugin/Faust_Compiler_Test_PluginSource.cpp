...
#include "Faust_Compiler_Test_PluginSource.h"
#include "../Faust_Compiler_Test_PluginConfig.h"

#include <AK/AkWwiseSDKVersion.h>

AK::IAkPlugin* CreateFaust_Compiler_Test_PluginSource(AK::IAkPluginMemAlloc* in_pAllocator)
{
    return AK_PLUGIN_NEW(in_pAllocator, Faust_Compiler_Test_PluginSource());
}

AK::IAkPluginParam* CreateFaust_Compiler_Test_PluginSourceParams(AK::IAkPluginMemAlloc* in_pAllocator)
{
    return AK_PLUGIN_NEW(in_pAllocator, Faust_Compiler_Test_PluginSourceParams());
}

AK_IMPLEMENT_PLUGIN_FACTORY(Faust_Compiler_Test_PluginSource, AkPluginTypeSource, Faust_Compiler_Test_PluginConfig::CompanyID, Faust_Compiler_Test_PluginConfig::PluginID)

Faust_Compiler_Test_PluginSource::Faust_Compiler_Test_PluginSource()
    : m_pParams(nullptr)
...
AkUInt32 Faust_Compiler_Test_PluginSource::GetSpeakerConfigChannelMask(int preAllocatedOutputs){
...
AKRESULT Faust_Compiler_Test_PluginSource::Init(AK::IAkPluginMemAlloc* in_pAllocator, AK::IAkSourcePluginContext* in_pContext, AK::IAkPluginParam* in_pParams, AkAudioFormat& in_rFormat)
{
    m_pParams = (Faust_Compiler_Test_PluginSourceParams*)in_pParams;
...
AKRESULT Faust_Compiler_Test_PluginSource::Term(AK::IAkPluginMemAlloc* in_pAllocator)
{
...
AKRESULT Faust_Compiler_Test_PluginSource::Reset()
{
    AKPLATFORM::OutputDebugMsg("Reset is called!\n");
    return AK_Success;
}

AKRESULT Faust_Compiler_Test_PluginSource::GetPluginInfo(AkPluginInfo& out_rPluginInfo)
{
...
void Faust_Compiler_Test_PluginSource::Execute(AkAudioBuffer* out_pBuffer)
{
...
AkReal32 Faust_Compiler_Test_PluginSource::GetDuration() const
{

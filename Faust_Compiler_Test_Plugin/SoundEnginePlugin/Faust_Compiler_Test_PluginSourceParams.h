...
#ifndef Faust_Compiler_Test_PluginSourceParams_H
#define Faust_Compiler_Test_PluginSourceParams_H
...
struct Faust_Compiler_Test_PluginRTPCParams
{
    AkReal32 fDuration;
};

struct Faust_Compiler_Test_PluginNonRTPCParams
{
};

struct Faust_Compiler_Test_PluginSourceParams
    : public AK::IAkPluginParam
{
    Faust_Compiler_Test_PluginSourceParams();
    Faust_Compiler_Test_PluginSourceParams(const Faust_Compiler_Test_PluginSourceParams& in_rParams);
    ...
    Faust_Compiler_Test_PluginRTPCParams RTPC;
    Faust_Compiler_Test_PluginNonRTPCParams NonRTPC;
};

#endif // Faust_Compiler_Test_PluginSourceParams_H

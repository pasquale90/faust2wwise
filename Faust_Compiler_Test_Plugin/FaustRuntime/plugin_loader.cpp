...
PluginLoader::PluginLoader()
    ...
    , effectPlugin(cfg, parameters, faustCompiler)
    , sourcePlugin(cfg, parameters, faustCompiler)
{
...
bool PluginLoader::createPlugin(std::string &dspCode, int audioInputID, std::string& errorMsg)
{
    ...
    bool dspCompiled = faustCompiler.compileDSP(dspCode, cfg, errorMsg);
    if (!dspCompiled)
    {
    ...
    bool dspuiCreated = faustCompiler.createDSPandUI();
    if (!dspuiCreated)
    {
    ...
    bool pluginConfigured = faustCompiler.configurePlugin(cfg, parameters);
    if (!pluginConfigured)
    {
